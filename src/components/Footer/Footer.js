...
const Footer = () => {
  return (
    <footer className="bg-black py-6">
      ...
      <hr class="my-6 border-gray-200 sm:mx-auto dark:border-theme_red_2 lg:my-8" />
      <div class="sm:flex sm:items-center sm:justify-between  px-16">
          <span class="text-xl text-theme_red_3 sm:text-center dark:text-theme_red_3">© 2023 <a href="https://flowbite.com/" class="hover:underline">Rollin</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 space-x-10 sm:justify-center sm:mt-0">
              <a href="/" class="text-theme_red_3 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="/" class="text-theme_red_3 hover:text-theme_red_2 dark:hover:text-white">
